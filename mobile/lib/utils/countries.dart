...
class Countries {
  static PhoneNumber extractPhone(String completePhoneNumber) {
    try {
      PhoneNumber phoneNumber;
      Country foundedCountry = countries.first;
      completePhoneNumber = completePhoneNumber.replaceAll("+", "");
      for (var country in countries) {
        String phone = completePhoneNumber.substring(
          country.dialCode.length,
          completePhoneNumber.length,
        );
        if (completePhoneNumber.startsWith(country.dialCode) &&
      ...
      phoneNumber = PhoneNumber(
        countryISOCode: foundedCountry.code,
        countryCode: '+${foundedCountry.dialCode}${foundedCountry.regionCode}',
        number: completePhoneNumber.substring(
      ...
      return PhoneNumber(
        countryISOCode: countries
            .where((element) => element.name == "United Arab Emirates")
            .first
            .code,
        countryCode:
            '+${countries.where((element) => element.name == "United Arab Emirates").first.dialCode}${countries.where((element) => element.name == "United Arab Emirates").first.regionCode}',
        number: "",
      );
    }
  }
